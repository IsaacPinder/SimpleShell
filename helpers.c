...
int getFromFile(char *histarr[20]) {
  ...
  FILE *fptr = fopen("/home/seb23132/Downloads/cs210-IsaacnScottUnstable/History.txt", "r");
...
//function probably shouldnt be void just wrote for quickness
  void sendToFile(int commandindex, char *histarr[20])
  {
    ...
    FILE *fptr;
     //opens file
     fptr = fopen("/home/seb23132/Downloads/cs210-IsaacnScottUnstable/History.txt", "w");
    ...
    fclose(fptr);
     ...
     void SaveAliasToFile(char* alias[10][2]) {
       ...
       FILE *fptr;
     //opens file
     fptr = fopen("/home/seb23132/Downloads/cs210-IsaacnScottUnstable", "w");
    //w for write
if (fptr == NULL) {
      printf("No History file found\n");
  ...
  for (int i = 0; i < 10; i++) {
    ...
    fclose(fptr);
     ...
     void LoadAliasToFile(char* alias[10][2]) {
      ...
      FILE *fptr;
     //opens file
     fptr = fopen("/home/seb23132/Downloads/cs210-IsaacnScottUnstable/.aliases", "r");
      if (fptr == NULL) {
      printf("No History file found\n");
      }
      char buffer[512]; 
